        ...
        <section className='p-9 w-screen'>
            <div className="flex justify-center">
                ...
                <div className='px-5 basis-1/4'>
                    ...
                    <div>
                        ...
                        <h4 className='mb-3'><span className="font-bold">stage: </span>{job.stage} </h4>
            ...
            <div className='flex px-5 mt-10'>
                <div className="basis-1/2">
                    ...
                    <ul className="px-5">
                        <li className="list-disc mb-3">What is the breakdown of the team and who does what?</li>
                        <li className="list-disc mb-3">What are you most excited about having a new person in this role?</li>
                        <li className="list-disc mb-3">What is your biggest pain point? How will this role alleviate that?</li>
                        <li className="list-disc mb-3">What advice would you give someone through the rest of the interviewing process?</li>
